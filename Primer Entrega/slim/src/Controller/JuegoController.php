...
class JuegoController extends Controlador
{
  ...
  public function crear(Request $request, Response $response) {
    ...
    if($token->a){
      ...
      $estaVacio = $this->validarCampo($solicitud,'nombre', 
      'El campo de nombre del juego esta vacio',$response);
      if($estaVacio != null){
        return $estaVacio;
      }
      
      $estaVacio = $this->validarCampo($solicitud,'clasificacion_edad',
        'El campo de clasificacion de edad esta vacio',$response);
      if($estaVacio != null){
        return $estaVacio;
      }
      
      $estaVacio = $this->validarCampo($files,'imagen',
      'El campo de imagen esta vacio',$response);
      if($estaVacio != null){
        return $estaVacio;
      } 
      
      $estaVacio = $this->validarCampo($solicitud,'descripcion',
      'El campo de descripcion esta vacio',$response);
      if($estaVacio != null){
        return $estaVacio;
      } 
