...
class Usuario extends Modelo
{
  ...
  protected $patronContraseña = "/^[A-Za-z0-9!#$%&'*\"\\-\\_\\+@?¡¿ñ]{8,16}$/";
  //Ahora se pueden poner comillas dobles
    ...
    try {
      ...
      if (!$existeUsuario) {
        ...
        */
        ...
        $this->data['Data']['a'] = $existeUsuario['es_admin'];
        $this->data['Data']['nombre_usuario'] = $solicitud['nombre_usuario'];
      }
