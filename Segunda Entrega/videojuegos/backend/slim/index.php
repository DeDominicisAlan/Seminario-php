...
use App\Controller\PlataformaController;
use App\Config\Config;
use App\Config\Middleware;
use App\Config\MiddlewareToken;
use App\Controller\SoporteController;
...
$app->group('', function () use ($app) {
    ...
    $app->post('/soporte', SoporteController::class . ':agregar');
...
$app->get('/calificaciones/{id}', CalificacionController::class . ':obtenerCalificaciones');
$app->get('/calificacion', CalificacionController::class . ':obtenerCalificacion');
...
$app->get('/juegosCompletos', JuegoController::class . ':obtenerJuegos');
...
$app->get('/plataformas', PlataformaController::class . ':obtener');
